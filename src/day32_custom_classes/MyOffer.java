...
public class MyOffer {
    ...
    public static void main(String[] args) {
        ...
        OfferV2 offer1 = new OfferV2 ("Facebook", "California",
                150000.00, true, 28);
        System.out.println(offer1);
        System.out.println("_____________");

        OfferV2 offer2 = new OfferV2("Anazon", "Arlington", 145000.00);
        System.out.println(offer2);


        ArrayList <String> listOfStr = new ArrayList<>(Arrays.asList("Hello", "Bye"));
        ArrayList <Integer> listOInteger = new ArrayList<>(Arrays.asList(1, 2, 3, 4));
        ...
        System.out.println("This is from Array LIST ");
        // can you print all the objects that are in offerList

        for ( OfferV2 each: offerList) {
            System.out.println(each);
            System.out.println("______________________");
        }
        System.out.println("This is from fori ");
