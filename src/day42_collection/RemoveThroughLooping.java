...
public class RemoveThroughLooping {
    public static void main(String[] args) {
        ...
        ArrayList <Integer> list = new ArrayList<>(Arrays.asList(2,3,5,0,6,12,35,6,2,5,6,2,3,1,4,5));
...
//        System.out.println(list);
        ...
        while (it.hasNext()){ //checks if there is element next to it(cursor), if not stop the loop
